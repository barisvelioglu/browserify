...
function closure ( target, options, originalOptions ){
	...
	function initialize ( target, originalOptions) {
		...
		nameDiv.className = "sliderInfo";
		nameDiv.dataset.id = api.target.getAttribute('data-id');

		var sliderName = api.target.getAttribute('data-name');

		if(sliderName){
			nameDiv.innerHTML = sliderName;
		}

		api.target.firstChild.appendChild(nameDiv)
