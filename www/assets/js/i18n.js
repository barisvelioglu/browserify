...
I18n.prototype = {
    ...
    __: function(){
        ...
        if (arguments.length > 1)
            msg = printf.vsprintf(msg, Array.prototype.slice.call(arguments, 1));
    ...
    __n: function(singular, count){
        ...
        msg = printf.vsprintf(msg, [count]);

        if (arguments.length > 2)
            msg = printf.vsprintf(msg, Array.prototype.slice.call(arguments, 2));
